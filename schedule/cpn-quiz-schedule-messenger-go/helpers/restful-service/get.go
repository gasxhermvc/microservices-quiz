...
func (r *Restful) HttpGet(endpoint string, request url.Values, filename string) ([]byte, int, error) {
	...
	req.Header.Add("x-client-id", config.GetString("cpn.quiz.api.filemanage.clientid"))
	req.Header.Add("x-api-key", config.GetString("cpn.quiz.api.filemanage.apikey"))
