...
func main() {
	...
	helloWorldRepository := _authRepository.NewAuthRepository(dbConn)
	helloWorldUseCase := _authUseCase.NewAuthUseCase(helloWorldRepository, log)

	//=>domain delivery
	_authDelivery.NewAuthDelivery(e, helloWorldUseCase, log)
